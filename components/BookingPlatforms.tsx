...
export default function BookingPlatforms() {
  const platforms = [
    {
      name: 'Booking.com',
      description: 'Đặt phòng trực tuyến, thanh toán linh hoạt',
      rating: '9.8/10',
      reviews: '13 đánh giá',
      icon: (
    ...
    {
      name: 'Agoda',
      description: 'Giá tốt nhất, ưu đãi độc quyền',
      rating: 'Best Price',
      reviews: 'Guarantee',
      icon: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'Facebook',
      description: 'Theo dõi và nhận ưu đãi mới nhất',
      rating: 'Follow Us',
      reviews: 'Latest Updates',
      icon: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'Instagram',
      description: 'Xem hình ảnh và video đẹp',
      rating: 'Gallery',
    ...
    {
      name: 'TikTok',
      description: 'Video ngắn về trải nghiệm',
      rating: 'Videos',
      reviews: 'Short Clips',
      icon: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    <section id="booking-platforms" className="py-20 md:py-32 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg md:text-xl text-foreground/70">
            Đặt phòng dễ dàng qua các nền tảng uy tín hoặc theo dõi chúng tôi
            trên mạng xã hội để cập nhật thông tin mới nhất
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {platforms.map((platform, index) => (
            ...
            >
              {/* Gradient Background */}
              <div className={`absolute inset-0 bg-gradient-to-br ${platform.color} opacity-90 group-hover:opacity-100 transition-opacity`} />
              ...
              <div className="relative p-8">
                ...
                {/* Description */}
                <p className={`${platform.textColor} opacity-90 mb-4`}>
                ...
                <div className={`${platform.textColor} opacity-80 text-sm`}>
                  ...
                  <div>{platform.reviews}</div>
                </div>

                {/* Arrow Icon */}
                <div className={`absolute bottom-8 right-8 ${platform.textColor} opacity-0 group-hover:opacity-100 transform translate-x-2 group-hover:translate-x-0 transition-all duration-300`}>
        ...
        {/* Quick Contact */}
        <div className="mt-16 bg-gradient-to-r from-neutral to-white rounded-2xl p-8 md:p-12 text-center">
          <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
            Liên Hệ Trực Tiếp
          </h3>
          <p className="text-foreground/70 mb-6 max-w-2xl mx-auto">
            Gọi ngay để được tư vấn và hỗ trợ đặt phòng tốt nhất
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-secondary hover:bg-primary-dark text-white font-semibold px-8 py-4 rounded-full transition-all duration-300 hover:scale-105 shadow-lg"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
